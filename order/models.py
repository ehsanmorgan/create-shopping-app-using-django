...
from shop.models import Electronic,Jewellery,Fashion
from django.contrib.auth.models import User
from django.utils import timezone
from .ultis.genirite_code import genirite_code
...
class order_detail(models.Model):
    ...
    product=models.ForeignKey(Electronic,related_name='order_product',on_delete=models.SET_NULL,null=True,blank=True)
